...
import bgFundoMobile from "@/assets/bg-fundo-mobile-v2.webp.asset.json";
...
export function HeroV2() {
  return (
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="shell relative z-10 grid items-center gap-10 pt-[360px] pb-14 md:py-16 lg:min-h-[92vh] lg:grid-cols-2 lg:pt-14 lg:pb-14">
